namespace GroceryFriendService.Migrations
{
    ...
    public partial class modelchangeintIds : DbMigration
    {
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Items", "Receipt_Id", "dbo.Receipts");
            DropIndex("dbo.TodoItems", new[] { "CreatedAt" });
            DropIndex("dbo.Users", new[] { "CreatedAt" });
            DropIndex("dbo.Receipts", new[] { "User_Id" });
            DropIndex("dbo.Receipts", new[] { "CreatedAt" });
            DropIndex("dbo.Items", new[] { "Receipt_Id" });
